...
const CardDetailPage: React.FC = () => {
  ...
  // Tu dodajemy stan do blokowania
  ...
  const handleApplication = async (form: ApplyForm) => {
    ...
    if (processing) return; // zapobiegamy wielokrotnemu submitowi
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-blue-50 via-blue-100 to-white py-16 px-6">
      <div className="max-w-4xl mx-auto relative">
        {/* Overlay blokujący formularz */}
        {processing && <FormOverlay />}
        ...
        >
          ...
          <div className="mt-6">
            ...
            <p className="text-gray-700 whitespace-pre-line leading-6">{jobOffer.description}</p>
          </div>
          <div className="mt-6">
        ...
        {user ? (
          <motion.form
            ...
            className={`bg-white rounded-2xl shadow-xl border border-blue-200 p-8 max-w-3xl mx-auto relative
              ${processing ? "pointer-events-none select-none" : ""}`}
          >
            ...
            {/* CV */}
            <div className="mt-6">
              <label className="text-sm font-medium text-gray-900 mb-1">Upload CV</label>
              <input
                type="file"
                required
            ...
            <button
              type="submit"
              disabled={processing}
              className={`mt-6 w-full py-3 rounded-xl font-medium shadow-md transition
                ${
                  processing
