...
namespace api.Data
{
    public static class DatabaseSeeder
    {
        ...
        {
            if (!context.Technology.Any()) // Jeśli tabela Technologies jest pusta
            {
                // Dodajemy technologie
                ...
                context.SaveChanges(); // Zapisujemy technologie w bazie
            }

            if (!context.JobOffer.Any()) // Jeśli tabela JobOffers jest pusta
            {
                // Dodajemy oferty pracy
                var jobOffers = new[]
                {
                    new JobOffer 
                    { 
                        ...
                        Description = "Entry-level backend dev position"
                    },
                    new JobOffer 
                    { 
                        ...
                        Salary = 12000, 
                        ProgrammingLanguage = "C#", 
                        Description = "Senior backend dev with 5+ years experience"
                    },
                    new JobOffer 
                    { 
                        ...
                        Description = "Frontend position for React developer"
                    },
                    new JobOffer 
                    { 
                        ...
                        Description = "Junior frontend developer using JavaScript and React"
                    },
                    new JobOffer 
                    { 
                        ...
                        Description = "Full stack developer with experience in Node.js and React"
                    },
                    new JobOffer 
                    { 
                        ...
                        Description = "Experienced engineer in Java with strong problem-solving skills"
                    },
                    new JobOffer 
                    { 
                        ...
                        JobType = "Full-Time", 
                        Salary = 4000, 
                        ProgrammingLanguage = "Manual Testing", 
                        Description = "Entry-level QA engineer, strong attention to detail"
                    },
                    new JobOffer 
                    { 
                        ...
                        Description = "Data scientist position focusing on machine learning and big data analysis"
                    },
                    new JobOffer 
                    { 
                    ...
                    { 
                        ...
                        JobType = "Full-Time", 
                        Salary = 7000, 
                        ProgrammingLanguage = "Design Tools", 
                        Description = "Creative UI/UX designer focusing on user-centered design"
                    }
                };

                context.JobOffer.AddRange(jobOffers);
                context.SaveChanges(); // Zapisujemy oferty pracy w bazie
            }
            if (!context.JobOfferTechnology.Any())
            {
            // Przypisujemy technologie do ofert pracy (relacja wielu do wielu)
            ...
            context.SaveChanges(); // Zapisujemy relacje w bazie
            }
        }
    }
}
